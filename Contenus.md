...
Le courant injecté est mesuré en permanence à l’aide d’une pince de mesure. On compare ce courant à la valeur de consigne, et le système ajuste automatiquement la puissance du générateur afin de maintenir un courant de mode commun constant. Cette méthode oﬀre une meilleure précision et une meilleure reproductibilité. En revanche, à certaines fréquences, la puissance maximale disponible peut ne pas sufre à atteindre la consigne fxée.
...
*-* La limitation de tous les harmoniques à la sortie de l’amplifcateur doit être inférieure à 15 dB par rapport à la fondamentale pour qu’il soit considéré comme adapté. Il convient alors de vérifer la linéarité de l’amplifcateur afin de s’assurer que si on augmente la puissance à l’entrée, la sortie augmente proportionnellement.

# 5. Mise en place du setup

## 5. 1. Logiciel de pilotage

Le pilotage du banc d’essai BCI est assuré par le logiciel emcware® v4.0 développé par AR RF/Microwave Instrumentation. On utilise ce logiciel pour automatiser les essais de compatibilité électromagnétique, que ce soit en immunité rayonnée ou en immunité conduite. Dans le cadre des essais BCI, on a un contrôle automatique du générateur RF, de l’amplifcateur de puissance et du coupleur directionnel. Le logiciel permet également d’acquérir les mesures issues de la pince de courant, d’exécuter le balayage fréquentiel et d’enregistrer l’ensemble des résultats. En mode boucle fermée, on bénéfcie d’un asservissement automatique du courant injecté. Le logiciel compare en permanence le courant mesuré à la consigne défnie et ajuste la puissance du générateur afin de maintenir un niveau constant malgré les variations d’impédance du faisceau. Grâce à cette automatisation, on améliore la reproductibilité des essais, on réduit les erreurs de manipulation et on assure une meilleure traçabilité des campagnes de test.
...
***Figure 4: Résultats de vérifcation – Niveau 1***

![Figure 4: Résultats de vérifcation – Niveau 1](Images/Res_1.PNG)


**Vérification**. La Figure 5 compare la tension issue du calibrage et celle de la vérification. La vérification confrme la répétabilité du vecteur $P(f)$ les écarts localisés sont compatibles avec la sensibilité du montage (adaptation 50 Ω imparfaite, puissance réﬂéchie, répétabilité mécanique du serrage et positionnement de la pince) et la stabilité thermique.

***Figure 5: Vérification : tension de calibrage vs tension de vérification (V) en fonction de la fréquence (MHz).***

![Figure 5: Vérification : tension de calibrage vs tension de vérification (V) en fonction de la fréquence (MHz).](Images/Res_2.PNG)

*-* Niveau 3

Même démarche que le niveau 2 : calcul du vecteur de puissance $P(f)$ avec application des corrections, contrôle de cohérence via forward et reverse et prise en compte des limites de puissance (risque de saturation, lien avec la vérifcation de linéarité amplifcateur).

**Puissance mesurée $P(f)$**. La Figure 6 présente une signature fréquentielle similaire au niveau 2 (réponse propre de la chaîne), avec un décalage global de puissance correspondant au niveau demandé.


***Figure 6: Résultats de calibration BCI – Niveau 3***

![Figure 6: Résultats de calibration BCI – Niveau 3](Images/Res_5.PNG)


*-* Vérifcation de la linéarité de l’amplifcateur

**Résultats de linéarité – Niveau 2**

Après l’obtention du vecteur de puissance $P(f)$ (table fréquence → puissance à rejouer), une vérifcation de la linéarité de l’amplifcateur est réalisée afin de s’assurer que l’amplifcateur ne fonctionne pas en saturation. Cette étape permet de confrmer que la table P(f) a été construite dans une zone de fonctionnement linéaire, et qu’une variation de consigne se traduit bien par une variation proportionnelle de la puissance mesurée. Le résultat est jugé conforme lorsque l’écart mesuré reste dans une fenêtre défnie entre une limite inférieure et une limite supérieure. Dans nos mesures, cette fenêtre est matérialisée sur les fgures par 3 dB (limite inférieure) et 7 dB (limite supérieure). Un écart mesuré nettement inférieur à la limite basse est un indicateur de compression : la puissance de sortie ne diminue plus proportionnellement à la consigne lorsque celle-ci est réduite.

La Figure 7 montre que l’écart mesuré est quasi constant, proche de ≈ 5 dB sur l’ensemble de la bande, et reste compris entre 3 dB et 7 dB. L’amplifcateur est donc considéré linéaire au niveau 2 sur toute la bande, ce qui valide l’utilisation de la table $P(f)$ associée.

***Figure 7: Vérifcation de la linéarité de l’amplifcateur – Niveau 2***

![Figure 6: Vérification de la linéarité de l’amplifcateur – Niveau 2](Images/Res_6.PNG)

**Résultats de linéarité – Niveau 2**

La Figure 8 met en évidence un comportement plus variable au niveau 3. L’écart est conforme sur une partie de la bande $(valeurs autour de 4–5 dB)$, mais passe également sous la limite inférieure de $3 dB$ sur plusieurs zones. Ces passages sous $3 dB$ traduisent un fonctionnement en compression : Lorsque la consigne est réduite de $5,1 dB$, la puissance mesurée sur la voie forward ne diminue plus de façon proportionnelle. Ce comportement peut être accentué à niveau élevé par la sensibilité de la chaîne d’injection (pince, câbles et adaptation), notamment en présence de puissance réﬂéchie mesurée sur la voie reverse. Dans ce cas, l’atteinte de la tension cible peut rester possible, mais la marge de fonctionnement linéaire n’est pas garantie sur toute la bande, ce qui augmente le risque de distorsion et de variabilité des niveaux. La Figure 8 montre la puissance mesurée par l’analyseur de spectre et en constate notamment au basse fréquence que les caractéristiques de l’amplifcateur restent parfaite.

***Figure 8: Vérification de la linéarité de l’amplifcateur – Niveau 3***

![Figure 6: Vérification de la linéarité de l’amplifcateur – Niveau 3](Images/Res_7.PNG)

# 7. Conclusion

À l’issue de ce projet, nous avons pu réaliser le test BCI (Bulk Current Injection), qui constitue l’un des essais les plus répandus dans le domaine de la compatibilité électromagnétique. Dans un premier temps, nous nous sommes attachés à assimiler les recommandations d’essais proposées par les normes en vigueur, notamment les normes ISO 11452-4 et EN 61000-4-6. La phase de qualifcation s’est ensuite révélée indispensable afin de pouvoir procéder au calibrage du setup. Nous avons ainsi réalisé plusieurs calibrages pour diﬀérents niveaux de sévérité, conformément aux exigences normatives, en utilisant deux méthodes d’injection de perturbations : la pince d’injection et le réseau de couplage et de découplage (CDN). Les résultats obtenus, ainsi que leur interprétation, nous ont permis de mettre en évidence l’importance d’utiliser des équipements préalablement calibrés et correctement caractérisés, afin de garantir la reproductibilité des essais et d’assurer la fabilité des résultats. Par ailleurs, les expériences menées ont montré que la qualité de la fonction de transfert de l’équipement d’injection joue un rôle déterminant. En eﬀet, un bon couplage permet d’atteindre les niveaux de sévérité requis (en tension ou en courant) sans nécessiter des puissances élevées, ce qui contribue à maintenir l’amplifcateur de puissance dans sa zone de linéarité. Enfin, nous avons également conclu qu’il est essentiel de disposer d’un amplifcateur présentant une bonne linéarité, afin d’éviter la génération d’harmoniques. Dans le cas contraire, il devient difcile de déterminer si la réponse de l’équipement sous test est due à la fréquence fondamentale ou à l’un de ses harmoniques. Ce travail ouvre également des perspectives d’amélioration, notamment en approfondissant l’analyse des phénomènes de couplage et en optimisant les confgurations de test, afin d’augmenter la précision et la robustesse des essais CEM.
